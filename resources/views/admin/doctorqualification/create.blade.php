            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mx-auto align-item-center">
                        <h1 class="card-header">Add Doctor Qualification</h1>
                        <div class="card-body">
                            <form action="{{ route('doctorqualification.store') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <input type="text" name="doctor_qulification" id="dqualification" class="form-control"
                                           placeholder="Doctor Qualification" value="{{ old('doctor_qulification') }}">
